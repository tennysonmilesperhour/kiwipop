...
- Create one product: **Kiwipop**. Use the four flavor names (Kiwi Pop / Lemon G. Luci / Molly's Mint / Mary Caramel Apple) as **variants**, not as separate products. This means customers see one product page and pick a flavor — cleaner UX, simpler inventory, and any reviews aggregate to one product.
